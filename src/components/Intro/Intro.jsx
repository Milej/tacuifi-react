  ...
  return (
    <div className="intro bg-no-repeat bg-cover min-h-screen">
      <div className="bg-black/30 min-h-screen">
        <h1 className="text-8xl py-40 text-center text-white font-semibold w-full">
          Cabañas Tacuifí
        </h1>
        <div className="container mx-auto bg-black/30 py-10 px-20 text-xl max-w-7xl rounded-lg">
